                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form class="user" action="{{ route('update-vehicle', $vehicle->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" name='title' class="form-control form-control-user" value='{{ $vehicle->title }}'  placeholder="Vehicle Type">
                                  @error('title')
                              ...
                              @enderror
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="file" id="exampleInputFile" name="icon" value="{{ old('icon', $vehicle->icon) }}">
                                  <!-- Show the current image name -->
                                    @if($vehicle->icon)
                                <p>Current Image: {{ basename($vehicle->icon) }}</p>
                                    @endif
                                  @error('icon')
                                  <span class="text-danger" role="alert">
                                      <strong>{{ $message }}</strong>
