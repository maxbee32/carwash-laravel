                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form class="user" action="{{ route('update-service',$services->id) }}" method="POST">
                                @csrf
                                {{-- @method('PUT') --}}
                                {{-- @if(!empty($editprices))
                            @foreach($editprices as $price) --}}
                                        ...
                                        {{-- @endforeach
                                            ...
                                            <div class="form-group">
                                                <label for="description"><b>Choose Description:</b></label>
                                                <select name="price_id" class="form-control form-control-user" id="description">
                                                    @foreach($prices as $price)
                                                        <option value="{{ $price->id }}" {{ $price->id == $services->price_id ? 'selected' : '' }}>
                                                            {{ $price->description }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name='service' class="form-control form-control-user" value='{{ $services->service }}' placeholder="Service">
                                                @error('service')
                                                    <span class="text-danger" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
