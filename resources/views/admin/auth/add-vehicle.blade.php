            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form class="user" action="{{ route('post-vehicle') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" name='title' class="form-control form-control-user"  placeholder="Vehicle Type">
                                  @error('title')
